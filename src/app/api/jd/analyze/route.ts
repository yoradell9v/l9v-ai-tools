...
import { runJDAnalysisPipeline, normalizeTasks, normalizeStringArray } from "@/lib/jd-analysis/pipeline";
...
// ============================================================================
// OLD ANALYSIS FUNCTIONS REMOVED - Now in @/lib/jd-analysis/pipeline.ts
// ============================================================================
// All analysis stages have been moved to the reusable pipeline module.
// The route now calls runJDAnalysisPipeline() instead of individual stages.
// ============================================================================
...
Respond with JSON:
{
  ...
  const kbContext = formatKnowledgeBaseContext(knowledgeBase, "role-builder");
