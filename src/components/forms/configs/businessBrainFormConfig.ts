  ...
  sections: [
    {
      id: "quick-start",
      title: "Quick Start",
      description: "Essential information to get your Business Brain working (8-10 minutes)",
      fields: [
        {
          id: "businessName",
          label: "Business Name",
        ...
        },
        {
          ...
          type: "textarea",
          placeholder: "We help course creators scale to $50k/month with done-for-you YouTube ads.",
          required: true,
        ...
        },
        {
          ...
          options: [
            ...
            { label: "Home Services & Contractors", value: "Home Services & Contractors" },
            { label: "Medical, Dental & Healthcare", value: "Medical, Dental & Healthcare" },
            { label: "Beauty, Aesthetics & Wellness", value: "Beauty, Aesthetics & Wellness" },
            { label: "Fitness & Sports", value: "Fitness & Sports" },
            { label: "Hospitality, Travel & Tourism", value: "Hospitality, Travel & Tourism" },
            { label: "Restaurants, Cafes & Food/Beverage", value: "Restaurants, Cafes & Food/Beverage" },
            { label: "Events, Weddings & Entertainment", value: "Events, Weddings & Entertainment" },
            { label: "Advertising, Marketing & Creative Services", value: "Advertising, Marketing & Creative Services" },
            { label: "Professional & B2B Services", value: "Professional & B2B Services" },
            { label: "Manufacturing, Industrial & Construction", value: "Manufacturing, Industrial & Construction" },
            { label: "Retail (Physical Store)", value: "Retail (Physical Store)" },
            { label: "Automotive", value: "Automotive" },
            { label: "Education & Training", value: "Education & Training" },
            { label: "Nonprofit, Charity, Church / Faith-Based", value: "Nonprofit, Charity, Church / Faith-Based" },
        ...
        },
        {
          ...
          required: true,
          options: [
            { label: "Pre-revenue / Just starting", value: "Pre-revenue / Just starting" },
        ...
        },
        {
          ...
          type: "textarea",
          placeholder: "If we only helped you achieve ONE outcome in the next 90 days, what should it be?",
          required: true,
        },
        {
          ...
          type: "textarea",
          placeholder: "What's the single biggest bottleneck slowing you down right now?",
          required: true,
        },
        {
          id: "idealCustomer",
        ...
        },
        {
          ...
          required: true,
          helpText: "What's it called, what does it promise, and what does it cost?",
        },
        {
          id: "customerJourney",
          label: "Simple Customer Journey",
          type: "text",
          placeholder: "See ad → opt in → email sequence → book call → close on Zoom",
          required: true,
          helpText: "In one line, describe the main path from stranger → client",
        },
        {
          id: "brandVoiceStyle",
          ...
          options: [
            { label: "Professional but friendly", value: "Professional but friendly" },
            { label: "Casual and conversational", value: "Casual and conversational" },
            { label: "Bold and high-energy", value: "Bold and high-energy" },
            { label: "Inspirational and story-driven", value: "Inspirational and story-driven" },
          ],
        },
        {
          ...
          options: [
            { label: "Low – keep it safe and conservative", value: "Low – keep it safe and conservative" },
            { label: "Medium – some bold hooks, nothing controversial", value: "Medium – some bold hooks, nothing controversial" },
            { label: "High – strong pattern interrupts and bold claims (within truth/legal limits)", value: "High – strong pattern interrupts and bold claims (within truth/legal limits)" },
          ],
        },
        {
          id: "primaryCRM",
          ...
          required: true,
          helpText: "Which platform do you mainly use for contacts and pipelines?",
        },
        {
          id: "bookingLink",
          label: "Booking Link",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "textarea",
          placeholder: "Case study: Helped client X achieve Y result in Z timeframe...",
      ...
      fields: [
        {
          ...
          type: "textarea",
          placeholder: "Paste examples of your best writing that captures your voice...",
        },
        {
          id: "voiceExamplesAvoid",
          label: "Paste 2-3 examples of tone you want to AVOID",
          type: "textarea",
          placeholder: "Paste examples of styles/tones that don't fit your brand...",
        },
        {
          id: "contentLinks",
          label: "Example Content You Like (Links)",
          type: "textarea",
          placeholder: "Drop 1-3 links to content (yours or others) that feel like the voice you want",
        },
      ],
    },
    {
